...
export default function Layout() {
  ...
  const [similarWorks, setSimilarWorks] = useState<string[]>([]);
  const [newSimilarWork, setNewSimilarWork] = useState('');

  const addSimilarWork = () => {
    if (newSimilarWork.trim()) {
      setSimilarWorks([...similarWorks, newSimilarWork.trim()]);
      setNewSimilarWork('');
    }
  };

  const removeSimilarWork = (index: number) => {
    setSimilarWorks(similarWorks.filter((_, i) => i !== index));
  };
        ...
        <div className="grid grid-cols-2 gap-10">
              ...
              <div className="border border-[#231f20] rounded p-4 min-h-[42px]">
                <div className="flex flex-wrap gap-2">
                  {similarWorks.map((work, index) => (
                    <div
                      key={index}
                      className="flex items-center gap-2 bg-white border border-[#231f20] rounded px-3 py-1"
                    >
                      <span className="font-ibm-plex-sans text-[15px] text-black">{work}</span>
                      <button
                        type="button"
                        onClick={() => removeSimilarWork(index)}
                        className="text-black hover:text-[#F36D31]"
                      >
                        <X className="w-3 h-3" />
                      </button>
                    </div>
          ...
          <div>
            ...
            <div className="mb-8">
              ...
              <div className="relative">
                <div className="border border-[#231f20] rounded px-4 py-2 min-h-[42px]">
                  <div className="flex flex-wrap gap-2">
                    {selectedGenres.map((genreId) => {
                      ...
                      return (
                        <div
                          ...
                          className="flex items-center gap-2 bg-white border border-[#231f20] rounded px-3 py-1"
                        >
                          <span className="font-ibm-plex-sans text-[15px] text-black">
                            {genre?.genre_name}
                          </span>
                          <button
                            type="button"
            ...
            <div className="mb-8">
              ...
              <div className="relative">
                <div className="border border-[#231f20] rounded px-4 py-2 min-h-[77px]">
                  <div className="flex flex-wrap gap-2">
            ...
            <Input
              type="hidden"
              name="synopsis"
              defaultValue="Placeholder synopsis"
            />
