  ...
  return (
    <div className={'container mx-auto'}>
      ...
      <div className={'inline'}>
        <div className={'inline-flex gap-1'}>
          {project.project_projectgenre.map(({ project_genre }) => (
            <span
              className={'bg-yo-orange rounded-[3px]'}
              key={project_genre.id}
            >
      ...
      <div className={'flex gap-5 text-lg my-5'}>
        <Link
          className={currentPath === 'about' ? 'opacity-50' : ''}
          to={'./about'}
        >
          Hakkında
        </Link>
        <Link
          className={currentPath === 'evaluations' ? 'opacity-50' : ''}
          to={'./evaluations'}
        >
          Değerlendirmeler
        </Link>
        <Link
          className={currentPath === 'metrics' ? 'opacity-50' : ''}
          to={'./metrics'}
        >
          Veriler
        </Link>
