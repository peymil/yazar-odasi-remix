...
import {Box, Key, LogIn, LogOut, MessageCircleQuestion, Percent, User, Wallet} from "lucide-react";
        ...
        <>
            <div className=" h-36 sticky flex items-center justify-evenly text-[#9197B3]">
                <div className={'relative w-32 h-32'}>
                    <img src={'https://cdn.yazarodasi.com/yazar_odasi_logo.svg'} alt={'yazar odasi logo'} sizes={'10vv'}/>
                </div>
                ...
                <form className="">
                    ...
                    <div className="relative">
                        ...
                        <input type="search" id="default-search"
                               ...
                               placeholder="Yazar, Proje ya da Çağrı " required/>
                    </div>
                </form>
